...
function Examwindow() {
    ...
    var languages = ['java', 'python', 'javascript', 'c', 'c++'];

    const cases = [{input: ['1 2 3', '3 4 1', '2 8 3'], output: ['1 2 3', '3 4 1', '2 8 3']}, {input: ['1 2 3', '3 4 1', '2 8 3'], output: ['1 2 3', '3 4 1', '2 8 3']}]
    // const results = [
    ...
    useEffect(() => {
        ...
        dispatch(initialize({questionDetails: tempArr, selected: 0}));
    }, []);
